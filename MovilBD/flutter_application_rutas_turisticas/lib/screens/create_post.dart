...
class _CreatePostScreenState extends State<CreatePostScreen> {
  ...
  Future<void> _checkManagedPlaces() async {
    ...
    try {
      final places = await _apiService.getManagedPlaces(
                          ...
                          setStateDialog(() {
                            ...
                            filteredPlaces = allPlaces.where((p) {
                              return p.nombre.toLowerCase().contains(query) ||
                                  (p.provincia?.toLowerCase().contains(query) ??
                                      false) ||
                                  (p.canton?.toLowerCase().contains(query) ??
                                      false);
                            }).toList();
                          });
                        },
                                ...
                                itemBuilder: (ctx, index) {
                                  ...
                                  return ListTile(
                                    ...
                                    onTap: () {
                                      setState(
                                        () => _selectedLugar = p,
                                      ); // Use 'this.setState' to update parent widget
                                      Navigator.pop(ctx);
                                    },
                                  );
                                },
          ...
          children: [
            ...
            ListTile(
              ...
              subtitle: _selectedLugar == null
                  ...
                  : Text(
                      _managedPlaces.any((dl) => dl.id == _selectedLugar!.id)
                          ? "Publicando como Administrador"
                          : "Publicando como Visitante",
                    ),
